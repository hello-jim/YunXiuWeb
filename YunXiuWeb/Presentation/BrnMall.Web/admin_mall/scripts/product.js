...
function setSelectedStore(item) {
    storeId = parseInt($(item).attr("storeId"));
    ...
    if (productPageType != 2) {
        ...
        $("#StoreCid").html("").prop("disabled", "disabled");
        $.get("/malladmin/store/storeclassselectlist?storeId=" + storeId + "&time=" + new Date(), function (data) {
            ...
            $("#StoreCid").html(html).prop("disabled", "");
        });

        $("#StoreSTid").html("").prop("disabled", "disabled");
        $.get("/malladmin/store/storeshiptemplateselectlist?storeId=" + storeId + "&time=" + new Date(), function (data) {
            ...
            $("#StoreSTid").html(html).prop("disabled", "");
        });
...
$(function () {
    ...
    if (productPageType != 2 && storeId > 0) {
        ...
        $.get("/malladmin/store/storeclassselectlist?storeId=" + storeId + "&time=" + new Date(), function (data) {
            ...
            $("#StoreCid").html(html).prop("disabled", "");
            $("#StoreCid").find("option[value=" + $("#hiddenStoreCid").val() + "]").prop("selected", true);
        });
        ...
        $.get("/malladmin/store/storeshiptemplateselectlist?storeId=" + storeId + "&time=" + new Date(), function (data) {
            ...
            $("#StoreSTid").html(html).prop("disabled", "");
            $("#StoreSTid").find("option[value=" + $("#hiddenStoreSTid").val() + "]").prop("selected", true);
        });
    }
