...
namespace BrnMall.Services
{
    ...
    public partial class AdminOrderAfterServices : OrderAfterServices
    {
        ...
        {
            BrnMall.Data.OrderAfterServices.ReceiveOrderAfterService(asId, OrderAfterServiceState.Received, receiveTime);
        }
        ...
        {
            BrnMall.Data.OrderAfterServices.BackOrderAfterService(asId, OrderAfterServiceState.Backed, shipCoId, shipCoName, shipSN, DateTime.Now);
        }
        ...
        {
            return BrnMall.Data.OrderAfterServices.GetOrderProductAfterServiceList(pageSize, pageNumber, condition);
        }
        ...
        {
            return BrnMall.Data.OrderAfterServices.GetOrderProductAfterServiceCount(condition);
        }
        ...
        {
            return BrnMall.Data.OrderAfterServices.GetOrderProductAfterServiceListCondition(storeId, uid, oid, state, type, applyStartTime, applyEndTime);
        }
    }
}
